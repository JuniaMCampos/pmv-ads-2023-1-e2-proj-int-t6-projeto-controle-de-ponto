...
namespace Apontei.Controllers
{
    public class PontosController : Controller
    {
        ...
        public PontosController(AplicationDbContext context)
        {
            _context = context;
        }
        ...
        {
            var aplicationDbContext = _context.Pontos.Include(p => p.Funcionario);
        ...
        public async Task<IActionResult> Create([Bind("Id,Data,HoraEntrada,HoraIntervaloInicial,HoraIntervaloFinal,HoraSaida,HorasExtras,Turno,FuncionarioId")] Ponto ponto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Data,HoraEntrada,HoraIntervaloInicial,HoraIntervaloFinal,HoraSaida,HorasExtras,Turno,FuncionarioId")] Ponto ponto)
        {
            if (id != ponto.Id)
            {
                return NotFound();
